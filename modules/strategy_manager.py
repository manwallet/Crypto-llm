...
class StrategyManager:
    ...
    def generate_signal(self):
        ...
        # 综合分析所有信号
        final_signal = self._combine_signals(tech_signals, lstm_prediction)
    ...
    def _combine_signals(self, tech_signals, lstm_signal):
        """综合所有信号"""
        ...
        final_score = (
            tech_score * 0.4 +
            getattr(self, 'latest_news_sentiment', 0) * 0.3 +
            lstm_signal * 0.3
        )
